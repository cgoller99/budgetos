  ...
  const menuPanel = open ? (
    <>
      ...
      <div
        ref={panelRef}
        role="menu"
        className="notification-panel-enter fixed overflow-hidden rounded-[var(--radius-card)] border border-[var(--surface-border)] bg-[var(--background)] shadow-2xl shadow-black/40"
        style={{
          zIndex: PANEL_Z,
          width: isMobile ? "min(14rem, calc(100vw - 24px))" : desktopStyle.width,
          ...(isMobile
            ? {
