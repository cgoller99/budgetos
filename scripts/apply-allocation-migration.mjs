#!/usr/bin/env node
/**
 * Applies the Financial Allocation Engine migration directly to Supabase Postgres.
 *
 * Usage: npm run apply:allocation-migration
 */
...
const MIGRATION_PATH = path.join(
  ROOT,
  "supabase/migrations/20260707_allocation_engine.sql",
);
...
async function main() {
  ...
  console.log("Applying Financial Allocation Engine migration...\n");
