#!/usr/bin/env node
/**
 * Applies the Stripe subscription migration directly to Supabase Postgres.
 *
 * Usage: npm run apply:stripe-migration
 */
...
const MIGRATION_PATH = path.join(
  ROOT,
  "supabase/migrations/20260705_stripe_subscriptions.sql",
);
...
async function main() {
  ...
  console.log("Applying Stripe subscription migration to Supabase Postgres...\n");
