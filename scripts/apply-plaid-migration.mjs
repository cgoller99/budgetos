#!/usr/bin/env node
/**
 * Applies the Plaid integration migration directly to Supabase Postgres.
 *
 * Usage: npm run apply:plaid-migration
 */
...
const MIGRATION_PATH = path.join(
  ROOT,
  "supabase/migrations/20260704_plaid_integration.sql",
);
...
async function main() {
  ...
  console.log("Applying Plaid integration migration to Supabase Postgres...\n");
