#!/usr/bin/env node
/**
 * Applies the household migration directly to Supabase Postgres.
 *
 * Set one of these in .env.local (Supabase Dashboard → Project Settings → Database):
 *   SUPABASE_DB_URL=postgresql://postgres:PASSWORD@db.PROJECT_REF.supabase.co:5432/postgres
 *   SUPABASE_DB_PASSWORD=your-database-password
 *
 * Usage: npm run apply:household-migration
 */
...
async function main() {
  ...
  console.log("Applying household migration to Supabase Postgres...\n");
