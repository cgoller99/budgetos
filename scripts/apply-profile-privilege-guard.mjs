#!/usr/bin/env node
/**
 * Applies profile privilege guard migration to Supabase Postgres.
 *
 * Usage: npm run apply:profile-privilege-gigration
 */
...
async function main() {
  ...
  console.log("Applying profile privilege guard migration...\n");
